...
const Contact = () => {
    ...
    return (
        <div id='contact' className='w-full px-[12%] py-10 scroll-mt-20 bg-[url("/footer-bg-color.png")] bg-no-repeeat bg-center bg-[length:90%_auto] dark:bg-none'>
            ...
            <p className='text-center max-w-2xl mx-auto mt-5 mb-12 font-Ovo'>
                I'd love to hear from you! If you have any questions, comments, or opportunities to present, please
                use the form below.
            </p>
